...
function install(){
 ...
 @media(min-width:760px){
  ...
  html[data-theme="dark"] .nh-card{background:rgba(44,37,31,.9)}html[data-theme="dark"] .nh-pc-intro{border-color:#514438}html[data-theme="dark"] .nh-pc-intro h1,html[data-theme="dark"] .nh-group-head h2{color:#f6ecdf}html[data-theme="dark"] .nh-status span,html[data-theme="dark"] .nh-icon{background:#2f2822;border-color:#5a4b3d;color:#dfba91}
 }
 ...
 const syncAccountFromGlobalMenu=()=>{
  ...
  const pcState=document.getElementById('nhPcState'); if(pcState)pcState.textContent=loggedIn?'SYNCED':'LOCAL';
 };
 let authBindTries=0;
