...
function install(){
 ...
 @media(min-width:760px){
  #${CURRENT_HOME_ID}{padding:26px 24px 42px}
  .nh-card{width:min(1120px,calc(100vw - 48px));max-width:none;display:grid;grid-template-columns:minmax(240px,290px) minmax(0,1fr);grid-template-areas:"brand brand" "account grid" "sync grid" "home grid" "theme grid" "help grid";grid-template-rows:auto auto auto auto auto 1fr;gap:12px 20px;padding:22px 24px 24px;border-radius:28px;box-shadow:0 22px 58px rgba(94,65,34,.14)}
  .nh-brand{grid-area:brand;min-height:82px;grid-template-columns:1fr 70px;padding:0 10px 18px;text-align:left}.nh-brand div{padding-left:0}.nh-brand b{font-size:1.28rem;letter-spacing:.15em}.nh-brand span{font-size:.8rem}.nh-brand img{width:66px;height:66px;justify-self:end}
  .nh-account{grid-area:account;margin-top:0;min-height:94px;grid-template-columns:58px 1fr 20px;gap:12px;padding:15px;border-radius:17px}.nh-avatar{width:56px;height:56px}.nh-avatar img{width:48px;height:48px}.nh-account-copy b{font-size:.96rem}.nh-account-copy span{font-size:.74rem}.nh-account-copy small{font-size:.68rem}
  .nh-sync{grid-area:sync;margin:0;min-height:56px;border-radius:14px;font-size:.9rem}
  .nh-grid{grid-area:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;align-self:start}.nh-tile{min-height:124px;padding:15px 10px;border-radius:17px}.nh-tile:hover{transform:translateY(-3px);border-color:#d5b991;box-shadow:0 11px 24px rgba(82,53,28,.1)}.nh-icon{height:38px;margin-bottom:9px;font-size:1.72rem}.nh-tile b{font-size:.82rem}.nh-tile small{margin-top:3px;font-size:.66rem}
  .nh-home{grid-area:home}.nh-theme{grid-area:theme}.nh-help{grid-area:help}.nh-wide{min-height:58px;margin-top:0;padding:10px 13px;border-radius:14px}.nh-wide b{font-size:.86rem}
 }
 @media(min-width:1120px){.nh-card{grid-template-columns:300px minmax(0,1fr);gap:14px 26px;padding:26px 30px 30px}.nh-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.nh-tile{min-height:132px}.nh-brand b{font-size:1.4rem}}
