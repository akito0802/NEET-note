...
const CORE_ASSETS=[
  './','./?mode=note','./index.html','./offline.html','./tools.html','./lyrics.html','./voice-memo.html','./ideas.html','./calendar.html','./neeton-home.html','./terms.html','./about.html',
  './style.css','./background.css','./chord-picker.css','./print.css','./common-ui.css','./common-ui.js','./app.js','./structure-sync.js','./chord-picker.js','./print.js','./lyrics-page.js','./voice-memo.js','./ideas.js','./seo.js',
  './favicon.svg','./neeton.svg','./neeton-versions.svg','./apple-touch-icon.png','./icon-192.png','./icon-512.png','./favicon-32x32.png','./favicon-16x16.png','./manifest.webmanifest'
];
...
const cacheOne=async(cache,url)=>{
  ...
  }catch(error){console.warn('[NEET NOTE] precache skipped:',url,error);}
};
...
self.addEventListener('fetch',event=>{
  ...
  const networkFirstNames=['cloud-sync.js','firebase-config.js','auth-fix.js','service-worker.js','common-ui.js','common-ui.css','manifest.webmanifest','seo.js'];
