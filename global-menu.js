...
loadConfig().then(async()=>{
  ...
  await (window.__neetSyncEngineLoading ||= new Promise((resolve,reject)=>{if(window.NEETSyncEngine)return resolve();const script=document.createElement('script');script.src=ROOT+'sync-engine.js?v=20260910-albums1';script.onload=resolve;script.onerror=reject;document.head.appendChild(script)}));
