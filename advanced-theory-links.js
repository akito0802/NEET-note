...
const tools=[
 ...
 {href:ROOT+'modulation-route.html?build=20260821-c9',icon:'◎',home:'転調メーカー',menu:'転調ルートメーカー',desc:'転調ルートを作る・理論を学ぶ',key:'modulation-route'},
