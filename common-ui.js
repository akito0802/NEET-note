...
const NEETON_FALLBACK='neeton.svg?v=3';
...
if(intro&&!intro.querySelector('.neeton-intro-image')){
 ...
 const style=document.createElement('style');style.textContent='.neeton-intro-image{display:block;width:min(38vw,150px);aspect-ratio:1;object-fit:cover;border-radius:32px;margin:0 auto 14px;box-shadow:0 12px 28px rgba(0,0,0,.18)}@media(max-width:520px){.neeton-intro-image{width:112px;border-radius:24px}}';
