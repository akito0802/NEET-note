...
if(list&&toolbar&&!document.getElementById('homeDashboard')){
 const style=document.createElement('style');style.textContent='.home-dashboard{margin-bottom:26px}.home-welcome{padding:clamp(20px,4vw,30px);border:1px solid var(--border);border-radius:22px;background:var(--paper);box-shadow:var(--shadow)}.home-welcome h2{margin:0;font-size:clamp(1.55rem,5vw,2.25rem)}.home-welcome>p{margin:10px 0 20px;color:var(--muted);line-height:1.75}.home-actions{display:flex;gap:10px;flex-wrap:wrap}.home-section-label{margin:26px 0 10px;color:var(--muted);font-size:.74rem;font-weight:800;letter-spacing:.14em}.home-tool-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.home-tool-card{display:flex;flex-direction:column;justify-content:center;gap:7px;min-height:92px;padding:16px;border:1px solid var(--border);border-radius:17px;background:var(--paper);color:var(--text);text-decoration:none;font-weight:800}.home-tool-card small{color:var(--muted);font-size:.75rem;font-weight:600;line-height:1.45}.home-tool-card.lyrics{background:linear-gradient(145deg,var(--paper),rgba(236,72,153,.08))}.home-tool-card.voice{background:linear-gradient(145deg,var(--paper),rgba(239,68,68,.07))}.home-tool-card.ideas{background:linear-gradient(145deg,var(--paper),rgba(234,179,8,.09))}.home-tool-card.tools{background:linear-gradient(145deg,var(--paper),rgba(59,130,246,.07))}.home-tool-card.theory{background:linear-gradient(145deg,var(--paper),rgba(139,111,71,.09))}@media(max-width:820px){.home-tool-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:480px){.home-actions{display:grid}.home-actions>*{width:100%;box-sizing:border-box}.home-tool-grid{grid-template-columns:1fr 1fr;gap:9px}}';document.head.appendChild(style);
 const d=document.createElement('div');d.id='homeDashboard';d.className='home-dashboard';d.innerHTML='<section class="home-welcome"><h2>思いついた音を、すぐ形に。</h2><p>作曲・歌詞・録音・アイデアを、それぞれ使いやすい場所に保存しよう。</p><div class="home-actions"><button id="homeNewSongBtn" class="primary-button">＋ 新しい曲を作る</button></div><p class="home-section-label">QUICK ACCESS</p><div class="home-tool-grid"><a class="home-tool-card lyrics" href="lyrics.html"><span>🎤 歌詞メモ</span><small>歌詞だけを独立して保存</small></a><a class="home-tool-card voice" href="voice-memo.html"><span>🎙 ボイスメモ</span><small>メロディをその場で録音</small></a><a class="home-tool-card ideas" href="ideas.html"><span>💡 アイデアメモ</span><small>曲名・MV・演出案を記録</small></a><a class="home-tool-card tools" href="tools.html"><span>🧰 制作ツール</span><small>移調・メトロノームなど</small></a><a class="home-tool-card" href="calendar.html"><span>📅 制作カレンダー</span><small>毎日の制作活動を記録</small></a><a class="home-tool-card theory" href="theory-assist.html"><span>🧠 理論アシスト</span><small>進行や次のコードを考える</small></a><a class="home-tool-card theory" href="theory-library.html"><span>📖 統合理論ライブラリ</span><small>音楽理論を順番に学ぶ</small></a><a class="home-tool-card" href="https://akito0802.github.io/Cordhyo-/index.html"><span>📚 コード</span><small>コードフォームを確認</small></a><a class="home-tool-card" href="https://akito0802.github.io/scale/"><span>🎸 スケール</span><small>音階を確認</small></a><a class="home-tool-card" href="https://akito0802.github.io/-h/"><span>🎵 指板</span><small>指板上の音を確認</small></a></div></section>';list.insertBefore(d,toolbar);document.getElementById('homeNewSongBtn')?.addEventListener('click',()=>document.getElementById('newSongBtn')?.click())
}

// 旧追加ダッシュボードが読み込まれても表示しない。メイン画面は既存のQUICK ACCESSだけを使う。
const removeExtraHome=()=>document.getElementById('neetHomeDashboard')?.remove();
removeExtraHome();
if(list)new MutationObserver(removeExtraHome).observe(list,{childList:true,subtree:true});
