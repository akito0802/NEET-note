...
if(!location.pathname.endsWith('terms.html')&&!location.pathname.endsWith('neeton-home.html'))load('firebase-config.js','20260805b').then(()=>load('cloud-sync.js','20260908-1')).catch(console.error);
})();